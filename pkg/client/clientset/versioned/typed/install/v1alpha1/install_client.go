...
import (
	...
	"github.com/tiagoangelozup/horusec-admin/pkg/client/clientset/versioned/scheme"
...
func (c *InstallV1alpha1Client) HorusecManagerSpecs(namespace string) HorusecManagerSpecInterface {
	return newHorusecManagerSpecs(c, namespace)
}
